...
def bin_op(a, b, i):
    ...
    if i == 0:
        ...
        return 1 - torch.max(1 - a, b)
    elif i == 3:
        return a
    elif i == 4:
        return 1 - torch.max(a, 1 - b)
    elif i == 5:
        return b
    elif i == 6:
        return 1 - torch.min(torch.max(1 - a,b),torch.max(a, 1 - b))
    elif i == 7:
        return torch.max(a,b)
    elif i == 8:
        return 1 - torch.max(a,b)
    elif i == 9:
        return torch.min(torch.max(1 - a,b),torch.max(a, 1 - b))
    elif i == 10:
        return 1 - b
    elif i == 11:
        return torch.max(a,1 - b)
    elif i == 12:
        return 1 - a
    elif i == 13:
        return torch.max(1-a,b)
    elif i == 14:
        return 1 - torch.min(a,b)
    elif i == 15:
